...
char *resume = "I'm currently job-seeking. My resume can be found as a pdf link(/resume/Daniel_Taylor_Resume_Dec_2022.pdf)[here] and also embeded using your browser's default pdf viewer below. Last updated January 2022.\n\n<embed src=\"/resume/Daniel_Taylor_Resume_Dec_2022.pdf\" style=\"width: 100%; height:800px\" type=\"application/pdf\">";
