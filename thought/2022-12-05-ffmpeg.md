...
Another important point is that the video and audio data streams are, in 100% of situations, going to be compressed. There are many different compression and decompression algorithms, called "codecs", and they should all be considered a black box. Modern video compression is quite complex. The spec for the vp8 codec, while short, was famously difficult to write. The new fancier version, vp9, doesn't even have an official spec! The other major video codecs like HVEC or AV1 aren't much better, they keep shoving more stuff in the bitstream. Audio codecs are usually much simpler but are still, in my opinion, not worth implementing if your final goal is just to read and write video files. Just don't roll your own.
