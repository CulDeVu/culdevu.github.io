...
These thoughts are based on conversations with Dupin and Clapeyron discussing to what extent, if any, the actions of peoples can be put on solid philosophical foundations.

Myself and my contemporaries feel awe and envy of Newton. His calculus of bodies in motion was a great gift to all students of philosophy. Taking after his example, everyone now wants a calculus of fluids. Generals want a calculus of tactics. Father wants a calculus of money and economies. But these are too narrow, splitting up our lives into pieces that can be reasoned. No one seems to want a calculus of *people* in their entirety.
...
People move independently inside their group, but as a whole will flow down streets, will fit the shape of a building they are in. They will bunch closer and flow slower when calm, but will spread and run out when agitated. This reminds me of Newton, who wrote of Man's mind as alchemical mercury. Fitting as people in this way, expanding and contracting with temperature, act like a mercury thermometer, measuring their own temperature. Perhaps Newton is ahead of us still.
...
Cornering them in the valley, containing them, that was good. A drop of oil in water will contain itself and not disperse, but that doesn't work with Romans and Samnites. You both contain Umbrian blood, and so so are at risk of diffusing in each other. If you want the Romans contained, and eventually removed in an irreversible way, you need an impermeable membrane. One preferably made of spears.
...
Alternatively they can be killed. The front line of a phalanx battle is a shoving game. I approximate the pressure felt at the front lines to be about 3000 Pa [todo: how]. When a solider falls they leave behind a vacuum that others rush into, about $(1m)(0.3m)(1.6m) \approx 0.5m^3$. With the constant crowd pressure, the vacuum does $P V \approx (3000 Pa)(0.5m^3) = 1500J$ of work on the crowds. Your army needs to be trained to take all that energy and use it to push the enemy harder. That energy has to go somewhere, and you don't want the Romans to have it!

The worst option would be to create a valve at the border, increase pressure, and squeeze the Romans through it. If you decide to do this, it's critical that your army maintains thermal contact, and that the squeeze is isothermal. Otherwise the army that exits the other side will have a very high temperature, and will raise the temperature of the Romans on the other side. Living next to hot Romans is a bad idea. Just be warned: this squeeze is isothermal, and therefore reversible. Romans can and will come back if you choose this option.

It's strange isn't it that the Latin tribes tend to be separated by mountains? Maybe not: 
...
It isn't until some generals show up that make large, adiabatic expansions that the pressure and temperature let up. Of course it would be an artillery officer, that profession all about temperature and pressure and expansion, that would eventually bring France's emergency to a close.
...
I notice that phrase, "non sunt condignae *passiones* huius temporis ad futuram *gloriam*", of course means the same as "non sunt condignae *gloriam* huius temporis ad futuram *passiones*". Rearrangement of the words in latin, to some extent, preserve their meaning. The ending *-am* on the accusative case of the first declension *gloria/gloriae* cannot be applied to the 3rd declension *passio/passionis*, and vise versa, locking in their roles in the sentence.

Similarly to an cavalry, consisting of many men moving freely while still possessing a military energy, or similarly to balls on a carom board, all moving but possessing a total unchanging kinetic energy, these words can be arranged in any fashion but still possess the same spiritual energy. The energy imparted on people via God's word, like light shining down on us from heaven, takes the form of independent utterances, discrete corpuscles. Landing with their full energy one at a time, with nothing in-between, just as Newton predicted.

What must the protestants think about this? Were that line read in a protestant church, the energy wouldn't feel the same. We can easily distinguish between "*suffering* now, *glory* later" and "*glory* now, *suffering* later". Much of the energy is contained in the *relationship* between nearby words, a sort of potential energy held in the space between words. The same words, the same light, but in the protestant church it arrives at the people as a continuum, like how Huygens predicted.

Corpuscles versus continuum, like the latin versus the vernacular mass, reflects the beliefs of the catholic Issac Newton versus protestant Christaan Huygens, which itself reflects the animosity of the British versus French at Leipzig (as Huygens lived in Paris most his life, and also was Hagenaaran, which had been annexed by Napoleon by then). And like before that, the Magna Carta versus the Declaration of the Rights of Man. It's like this, maybe all the way back to the very beginning, to discrete islands separated by water versus the continuous continent. And now we're back to the start again.
