...
img(shutter.svg)[A square wave pattern realized with rectangles. It has a period of 7/8 = 0.875]

img(alias.svg)[Pixel coverage of this pattern as reported by gezira. Note that the 7/8 period has aliased to a period of 8.]
...
[todo: talk more about how the js one runs, but none of the others do]
